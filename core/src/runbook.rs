...
/// Logo (crate::brand, provided at runtime) inlined as a data URI so a generated
/// runbook is self-contained (no external references; the PDF renders offline).
/// Empty string when no logo was provided.
fn logo_data_uri() -> String {
    use base64::Engine;
    match crate::brand::logo() {
